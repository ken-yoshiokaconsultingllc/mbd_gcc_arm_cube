...
enum opt_code
{
  ...
  OPT_fcyclomatic_complexity = 910,          /* -fcyclomatic-complexity */
  ...
  OPT_mfix_cmse_cve_2021_35465 = 1615,       /* -mfix-cmse-cve-2021-35465 */
  ...
  OPT_mlibarch_ = 1623,                      /* -mlibarch= */
  OPT_mlittle_endian = 1624,                 /* -mlittle-endian */
  OPT_mlong_calls = 1625,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1626,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1627,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1628,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1629,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1630,               /* -mprint-tune-info */
  OPT_mpure_code = 1631,                     /* -mpure-code */
  OPT_mrestrict_it = 1632,                   /* -mrestrict-it */
  OPT_msched_prolog = 1633,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1634,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1635,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1636, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1637,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1638,                         /* -mthumb */
  OPT_mthumb_interwork = 1639,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1640,                  /* -mtls-dialect= */
  OPT_mtp_ = 1641,                           /* -mtp= */
  OPT_mtpcs_frame = 1642,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1643,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1644,                         /* -mtune= */
  OPT_munaligned_access = 1645,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1646,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1647,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1648,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1649,              /* -mword-relocations */
  OPT_n = 1650,                              /* -n */
